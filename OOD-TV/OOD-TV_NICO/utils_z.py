...
class NICO(object):
    ...
    def fetch_train(self):
        ...
        train_g = F.one_hot(bs[1], num_classes=self.classNum)
    ...
    def fetch_test(self):
        ...
        test_g = F.one_hot(bs[1], num_classes=self.classNum).float()
        return (
            test_x.cuda(),
            # test_y.cuda(),
            None,
    ...
    def fetch_val(self):
        ...
        val_g = F.one_hot(bs[1], num_classes=self.classNum).float()
        return (
            val_x.cuda(),
            # val_y.cuda(),
            None,
