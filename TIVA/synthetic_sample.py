...
default_dict = {"inner_steps": 1, "step_round":3, "step_gamma":0.1, 
                "hidden_dim":390,  "data_num_train":2000, 
                "data_num_test":2000, "grayscale_model": False, 
                "l2_regularizer_weight":0.001, "penalty_anneal_iters":200, 
                "lr": 0.0004, "steps":10000, "envs_num_train":2, "dim_inv":2, 
                "penalty_weight":10000, "cons_ratio": "0.9_0.8_0.1", 
                "noise_ratio":0.1}
exclude_names = [
    "print_every",
    "variance_gamma",
