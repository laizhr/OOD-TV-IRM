...
## added by w wang
def train_penalty_computer(train_nll, infered_envs, scale, flags):
    train_penalty = 0
    if flags.dataset == "landcover":   # also for any dataset that is trained with mini-batch manner.
    ...
    elif flags.dataset != "landcover" and flags.num_classes > 1:
